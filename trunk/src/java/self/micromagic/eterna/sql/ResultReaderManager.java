...
public interface ResultReaderManager
{
    ...
    *
    * @see    self.micromagic.eterna.sql.ResultReaderManager#getReaderList(Permission)
    * @see    self.micromagic.eterna.sql.ResultReaderManager#getReaderInList(int)
    */
    ...
    * 一般用在通过xml装载后, 在SQLAdapterFactory的初始化中调用此方法.
    * 注:在调用了copySelf方法后, 新复制的ResultReaderManager是不被锁住的.
    *
    * @see    self.micromagic.eterna.sql.ResultReaderManager#copy(String)
    */

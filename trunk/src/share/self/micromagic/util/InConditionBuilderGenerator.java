...
public class InConditionBuilderGenerator extends AbstractGenerator
      implements ConditionBuilderGenerator, ConditionBuilder
{
   ...
   public ConditionBuilder.Condition buildeCondition(String colName, String value,
         ...
         throws ConfigurationException
   {
      if (value != null && value.length() > 0)
      {
         ...
         if (values.length > 0)
         {
            ...
            sqlPart.append(')');
            return new ConditionBuilder.Condition(sqlPart.toString(), preparers);
         }
      }
      return null;
   }
